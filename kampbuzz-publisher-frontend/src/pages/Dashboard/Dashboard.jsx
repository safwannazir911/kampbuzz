...
export function Dashboard() {
  ...
  const fetchUserProfile = async () => {
    ...
    try {
      ...
      // console.log("Dashboard Res", response.data.publisher);
      if (response.data) {
  ...
  const handleRequestMoreKcoins = () => {
    // Logic to send a message for requesting more kcoins
    setOpenDialog(true); // Open the dialog
  };

  const handleSendMessage = () => {
    // Logic to send the message
    toast.success("Message sent to the institution!");
    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
          ...
          <DropdownMenu>
            ...
            <div className="flex items-center justify-between ">
              ...
              <Button
                size="icon-small"
                variant="outline"
                onClick={handleRequestMoreKcoins}
                className="mr-2"
              >
                <Plus className="h-5 w-5 text-green-500" />
                <p className="hidden md:flex p-1 pl-0">Add More</p>
              </Button>
        ...
        <Dialog open={openDialog} onOpenChange={setOpenDialog}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Request More Kcoins</DialogTitle>
            </DialogHeader>
            <form
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              <textarea
                placeholder="Write a message to request more Kcoins"
