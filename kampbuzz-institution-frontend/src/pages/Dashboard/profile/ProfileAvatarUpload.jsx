...
const institutionProfileAvatarUploadSchema = z.object({
...
const ProfileAvatarUpload = () => {
  ...
  const form = useForm({
    resolver: zodResolver(institutionProfileAvatarUploadSchema),
  });
  ...
  const submit = async (data) => {
    ...
    setUploading(true);
    try {
      const res = await crudServices.uploadInstitutionAvatar(formData);
          ...
          {loading ? (
            ...
            <div className="flex justify-center items-center">
              <img
                ...
                src={institution?.avatar || "https://via.placeholder.com/200"}
                height={200}
                width={200}
              />
            </div>
